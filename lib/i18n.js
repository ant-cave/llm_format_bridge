...
const locales = {
  zh: {
    ...
    'config.add.force-disable-thinking': '强制关闭思考 (Force disable thinking)?',
    ...
    'menu.switch-lang': '切换语言 (Switch Language)',
    'menu.edit': '编辑配置项',
    'lang.changed': '语言已切换为',
    'edit.select-type': '选择要编辑的类型:',
    'edit.select-item': '选择要编辑的项目:',
    'edit.field': '字段',
    'edit.current': '当前值',
    'edit.new-value': '新值 (留空保持不变)',
    'edit.saved': '已更新',
    'edit.no-items': '没有可编辑的项目',
  ...
  en: {
    ...
    'config.add.force-disable-thinking': 'Force disable thinking?',
    ...
    'menu.action-failed': 'Action failed',
    ...
    'menu.switch-lang': 'Switch Language',
    'menu.edit': 'Edit Config Item',
    'lang.changed': 'Language switched to',
    'edit.select-type': 'Select type to edit:',
    'edit.select-item': 'Select item to edit:',
    'edit.field': 'Field',
    'edit.current': 'Current',
    'edit.new-value': 'New value (leave blank to keep)',
    'edit.saved': 'updated',
    'edit.no-items': 'No items to edit',
